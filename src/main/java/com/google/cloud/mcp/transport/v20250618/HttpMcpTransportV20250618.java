...
package com.google.cloud.mcp.transport.v20250618;
...
public final class HttpMcpTransportV20250618 extends BaseMcpTransport {
      ...
      JsonRpc.Request initReq =
          new JsonRpc.Request(
              ...
              new JsonRpc.InitializeParams(
                  ProtocolVersion.VERSION_2025_06_18.getValue(), "mcp-toolbox-sdk-java"));
              ...
              res -> {
                ...
                try {
                  ...
                  if (result != null && result.has("protocolVersion")) {
                    ...
                    serverVersion = ProtocolVersion.VERSION_2025_06_18.getValue();
                  }

                  if (!ProtocolVersion.VERSION_2025_06_18.getValue().equals(serverVersion)) {
                    return CompletableFuture.failedFuture(
                        new McpException(
  ...
  protected void applyProtocolHeaders(final HttpRequest.Builder builder) {
    ...
    builder.header("MCP-Protocol-Version", ProtocolVersion.VERSION_2025_06_18.getValue());
  }
}
